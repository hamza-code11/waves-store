...
const ProductCard = ({ product, isDarkMode }) => {
  ...
  return (
    <div className="relative">
      {/* Main Product Card - Now wrapped in Link */}
      <Link 
        to={`/product`}
        className={`group relative rounded-xl transition-all duration-300 border overflow-hidden block
          ${isDarkMode 
        ...
        <div className="p-4 pt-2">
          ...
          <button 
            onClick={(e) => {
              ...
              e.stopPropagation();
              // Add to cart logic here
              console.log("Add to cart (mobile):", product.id);
            }}
